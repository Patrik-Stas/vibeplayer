...
- [x] Input bar accepting URLs and natural language
- [x] yt-dlp download to local cache
- [x] rodio mp3 playback with play/pause/skip
- [x] Simple amplitude-based ASCII visualizer
- [x] "Up Next" queue panel
- [x] Claude API integration with tool calling
- [x] LLM-powered song discovery (via ytsearch)
- [x] LLM-powered queue manipulation
- [x] Volume control
- [x] Keyboard shortcuts for basic controls
